const mapBlueStyle={
  ...
  "layers": [
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {
        "fill-color": {"base": 1, "stops": [[12, "#123A51"], [20, "#123A51"]]},
        "fill-outline-color": "#123A51"
      }
    },
    {
      "id": "院落-医院",
    ...
    },
    {
      ...
      "layout": {"visibility": "visible"},
      "paint": {"fill-color": "rgba(1, 67, 69, 1)"}
    },
    {
      "id": "道路面-路口",
      "type": "fill",
      ...
      "filter": ["all", ["==", "$type", "Polygon"]],
      "layout": {"visibility": "visible"},
      "paint": {"fill-color": "rgba(0, 81, 84, 1)"}
    },
    {
      "id": "植被-城市",
      "type": "fill",
