...
function MapboxglSpiderifier(map, userOptions) {
    ...
    function createMarkerElements(spiderLegParam,feature) {
      ...
      pinElem.setAttribute("deta-title",feature.LEIBIE+"("+feature.NUM+")");
      pinElem.innerHTML=feature.NUM;
      pinElem.className = 'spider-leg-pin sprite ' + (options.customPin ? feature.type : ' default-spider-pin');
