 ...
 * @Last Modified by: 史涛
 * @Last Modified time: 2020-03-02 19:34:10
 */


var {CHANGE_MAP_VIEW, CHANGE_MOUSE_POINTER,
    CHANGE_ZOOM_LVL, CHANGE_MAP_CRS, CHANGE_MAP_SCALES, ZOOM_TO_EXTENT, PAN_TO,
    CHANGE_MAP_STYLE, CHANGE_ROTATION, UPDATE_VERSION, ZOOM_TO_POINT,CHANGE_MAP_MODULE, RESIZE_MAP} = require('../actions/map');
